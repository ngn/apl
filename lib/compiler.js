...
define(['./parser', './helpers', './builtins', './complex'], function(parser, helpers, builtinsModule, complex) {
  var assert, assignParents, builtinVarInfo, builtins, closestScope, compile, createHash, die, exec, execJS, hex4, inherit, jsName, lexer, next, ord, predefinedNames, repr, resolveSeqs, setInput, toJavaScript;
  if (parser == null) {
  ...
  setInput = lexer.setInput, next = lexer.next;
  ...
  resolveSeqs = function(ast) {
    ...
    while (queue.length) {
      ...
      visit = function(node) {
        var a, c, child, h, i, j, name, t, t1, v, _i, _j, _k, _len, _len1, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
        switch (node[0]) {
          case 'body':
          ...
          case 'seq':
            ...
            if (h.length === 3 && ((h[0].type === (_ref14 = h[1].type) && _ref14 === (_ref13 = h[2].type)) && _ref13 === 'F')) {
              a = [['fork'].concat(a)];
              h = [
                {
                  type: 'F'
            ...
            a[0].parent = null;
            _ref24 = node.slice(1);
            for (_k = 0, _len1 = _ref24.length; _k < _len1; _k++) {
              c = _ref24[_k];
              if (c) {
                c.parent = node;
              }
  ...
  toJavaScript = function(ast) {
    var k, s, v, visit;
    visit = function(node) {
      var a, c, child, d, getter, i, n, name, r, s, setter, v, x, _ref;
      switch (node[0]) {
        case 'body':
          r = '';
          if (node.length === 1) {
