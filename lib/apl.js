(function() {
  var BTM, BTMLFT, BTMRGT, LFT, PI, RGT, TOP, TOPLFT, TOPRGT, abs, acos, ambivalent, arrayValueOf, asin, atan, booleanValueOf, builtins, catenate, ceil, cos, depthOf, dyadic, exec, exp, floor, format, format0, hpad, infixOperator, inherit, isSimple, log, main, max, min, monadic, niladic, numericValueOf, outerProduct, pervasive, postfixOperator, pow, prefixOperator, prod, random, reduce, repeat, shapeOf, sin, sqrt, sum, tan, vpad, withShape, _ref;
