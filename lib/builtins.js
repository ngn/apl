...
(function() {
  ...
  prefixOperator = function() {
    var a, _base, _ref1;
    a = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return ((_ref1 = (_base = def.apply(null, [tmp.monadic].concat(__slice.call(a)))).aplMetaInfo) != null ? _ref1 : _base.aplMetaInfo = {}).isPrefixOperator = true;
  };

  postfixOperator = function() {
    var a, _base, _ref1;
    a = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return ((_ref1 = (_base = def.apply(null, [tmp.monadic].concat(__slice.call(a)))).aplMetaInfo) != null ? _ref1 : _base.aplMetaInfo = {}).isPostfixOperator = true;
  };

  infixOperator = function() {
    var a, _base, _ref1;
    a = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return ((_ref1 = (_base = def.apply(null, [tmp.dyadic].concat(__slice.call(a)))).aplMetaInfo) != null ? _ref1 : _base.aplMetaInfo = {}).isInfixOperator = true;
  };
