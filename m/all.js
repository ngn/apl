...
(function() {
  ...
  APLArray = (function() {
    function APLArray(data, shape, stride, offset) {
      ...
      if (!(this.data instanceof Array || typeof this.data === 'string')) {
        throw Error("\"assert @data instanceof Array or typeof @data is 'string'\" at src/array.coffee:95");
      }
  ...
  depthOf = function(x) {
    var axis, r, t77, t78, t79, t80, t81, t82, t83, t84, y, _i, _ref;
    if (x instanceof APLArray) {
  ...
  addVocabulary({
    '∪': function(omega, alpha) {
      var a, axis, data, t100, t85, t86, t87, t88, t89, t90, t91, t92, t93, t94, t95, t96, t97, t98, t99, x, _i, _j, _k, _len, _ref, _ref1, _ref2;
      if (alpha) {
        data = [];
        _ref = [alpha, omega];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
  ...
  addVocabulary({
    '↓': function(omega, alpha, axis) {
      var a, array, data, i, ishape, obound, offset, oshape, shape, tmp101, x, _i, _j, _k, _len, _len1;
      if (alpha) {
        if (alpha.shape.length > 1) {
          rankError();
        }
  ...
  enlist = function(x, r) {
    var axis, t102, t103, t104, t105, t106, t107, t108, t109, y, _i, _ref, _results;
    if (x instanceof APLArray) {
      t102 = x;
      if (!t102.empty()) {
        t104 = t102.data;
  ...
  addVocabulary({
    '!': withIdentity(1, pervasive({
      ...
      dyad: Beta = real(function(n, k) {
        ...
        if (((tmp111 = (n)) === ~~tmp111) && ((tmp112 = (k)) === ~~tmp112)) {
          return Math.round(r);
        } else {
          return r;
        }
  ...
  addVocabulary({
    '⍎': function(omega, alpha) {
      var axis, c, s, t114, t115, t116, t117, t118, t119, t120, t121, _i, _ref1;
      if (alpha) {
        return nonceError();
      } else {
        s = '';
  ...
  grade = function(omega, alpha, direction) {
    var axis, h, indices, t122, t123, t124, t125, t126, t127, t128, x, _i, _j, _ref1, _ref2, _results;
    h = {};
    if (alpha) {
      if (!alpha.shape.length) {
        rankError();
  ...
  addVocabulary({
    '⍳': function(omega, alpha) {
      var a, axis, d, data, indices, tmp136, _i, _j, _len, _ref1, _results;
      if (alpha) {
        if (alpha.shape.length !== 1) {
          rankError();
        }
        return omega.map(function(x) {
          var axis, e, indices, r, t129, t130, t131, t132, t133, t134, t135, y, _i, _ref1;
          try {
            r = alpha.shape;
            t129 = alpha;
            if (!t129.empty()) {
  ...
  deal = function(omega, alpha) {
    var h, i, j, r, tmp144, tmp145, _i, _j, _ref1, _results;
    alpha = alpha.unwrap();
    omega = omega.unwrap();
