...
define(['./parser', './helpers', './builtins', './complex'], function(parser, helpers, builtinsModule, complex) {
  var assert, assignParents, builtinVarInfo, builtins, closestScope, compile, createHash, die, exec, execJS, hex4, inherit, jsName, lexer, next, ord, predefinedNames, repr, resolveSeqs, setInput, toJavaScript, _ref, _ref1;
  if (parser == null) {
  ...
  createHash = function(s) {
    var h, k, kv, v, _i, _len, _ref2, _ref3;
    h = {};
    _ref2 = s.split('\n');
  ...
  (function() {
    var k, v, _ref2, _ref3, _ref4, _ref5, _results;
    _results = [];
    for (k in builtins) {
      v = builtins[k];
      v = builtins[k];
      builtinVarInfo[k] = typeof v !== 'function' ? {
        type: 'X'
      } : ((_ref2 = v.aplMetaInfo) != null ? _ref2.isNiladicFunction : void 0) ? {
        type: 'F',
        isNiladicFunction: true
      } : ((_ref3 = v.aplMetaInfo) != null ? _ref3.isPrefixOperator : void 0) ? {
        type: 'F',
        isPrefixOperator: true
      } : ((_ref4 = v.aplMetaInfo) != null ? _ref4.isPostfixOperator : void 0) ? {
        type: 'F',
        isPostfixOperator: true
      } : ((_ref5 = v.aplMetaInfo) != null ? _ref5.isInfixOperator : void 0) ? {
        type: 'F',
  ...
  resolveSeqs = function(ast) {
    var node, queue, scopeNode, vars, visit, _i, _len, _ref2;
    ...
    while (queue.length) {
      ...
      visit = function(node) {
        var a, c, child, h, i, j, name, t, t1, v, _i, _j, _k, _len, _len1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
        switch (node[0]) {
          case 'body':
          ...
          case 'seq':
            ...
            h.reverse();
            a.reverse();
            for (i = _j = 0, _ref4 = a.length; 0 <= _ref4 ? _j < _ref4 : _j > _ref4; i = 0 <= _ref4 ? ++_j : --_j) {
            ...
            while (--i >= 0) {
              if (h[i + 1].isInfixOperator && (h[i].type === 'F' || h[i + 2].type === 'F')) {
                [].splice.apply(a, [i, (i + 3) - i].concat(_ref8 = [['infixOperator'].concat(a.slice(i, i + 3))])), _ref8;
            ...
            while (i < a.length - 1) {
              if (h[i].type === 'F' && h[i + 1].isPostfixOperator) {
                [].splice.apply(a, [i, (i + 2) - i].concat(_ref10 = [['postfixOperator'].concat(a.slice(i, i + 2))])), _ref10;
            ...
            while (--i >= 0) {
              if (h[i].isPrefixOperator && h[i + 1].type === 'F') {
                [].splice.apply(a, [i, (i + 2) - i].concat(_ref12 = [['prefixOperator'].concat(a.slice(i, i + 2))])), _ref12;
            ...
            if (h.length === 3 && ((h[0].type === (_ref16 = h[1].type) && _ref16 === (_ref15 = h[2].type)) && _ref15 === 'F')) {
              a = [['fork'].concat(a)];
              h = [
                {
                  type: 'F'
  ...
  toJavaScript = function(ast) {
    var k, s, v, visit;
    visit = function(node) {
      var a, c, child, d, getter, i, n, name, r, s, setter, v, x, _ref2;
      switch (node[0]) {
        case 'body':
          r = '';
          if (node.length === 1) {
        ...
        case 'assign':
          ...
          if (((_ref2 = (v = closestScope(node).vars[setter = "set_" + name])) != null ? _ref2.type : void 0) === 'F') {
            v.used = true;
