...
(function() {
  ...
  resolveSeqs = function(ast) {
    ...
    while (queue.length) {
      ...
      visit = function(node) {
        var a, c, child, h, i, j, name, t, t1, _i, _j, _len, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
        switch (node[0]) {
          case 'body':
  ...
  toJavaScript = function(ast) {
    var k, s, v, visit;
    visit = function(node) {
      var a, alternative, c, child, d, n, name, r, s, setter, v, x, _ref1;
      switch (node[0]) {
        case 'body':
          r = '';
          ...
          return r += a.join(';\n');
        case 'guard':
          alternative = node.type === 'X' ? '0' : '(function () {return 0;})';
          return "(" + (visit(node[1])) + ") ? (" + (visit(node[2])) + ") : " + alternative;
        case 'assign':
          name = node[1];
  ...
  (function() {
    var r;
    r = exec('a←3 2 5⍴"joe  doe  bob  jonesbob  zwart"  ◇  a[⍋a;;]', {
      debug: true
    });
