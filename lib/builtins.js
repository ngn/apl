...
(function() {
  ...
  monadic('⍳', 'Index generate', function(a) {
    var r, rec, x, _i, _j, _k, _len, _ref1, _results, _results1;
    if (typeof a === 'number') {
      return (function() {
        _results = [];
    ...
    if (a.length === 1) {
      return (function() {
        _results1 = [];
        for (var _k = 0, _ref1 = a[0]; 0 <= _ref1 ? _k < _ref1 : _k > _ref1; 0 <= _ref1 ? _k++ : _k--){ _results1.push(_k); }
        return _results1;
      }).apply(this);
    }
    r = [];
    rec = function(d, indices) {
      var i, _l, _ref2, _results2;
      if (d >= a.length) {
        return r.push(indices);
      } else {
        _results2 = [];
        for (i = _l = 0, _ref2 = a[d]; 0 <= _ref2 ? _l < _ref2 : _l > _ref2; i = 0 <= _ref2 ? ++_l : --_l) {
