(function() {
  var builtins, cps, cpsify, exec0, inherit, parse, trampoline, _ref;
  builtins = require('./builtins').builtins;
  _ref = require('./helpers'), inherit = _ref.inherit, trampoline = _ref.trampoline, cps = _ref.cps, cpsify = _ref.cpsify;
  ...
  exec0 = function(ast, ctx, callback) {
    var F, a, code, getter, i, name, r, s, value;
    switch (ast[0]) {
      case 'body':
        i = 1;
        r = [];
      ...
      case 'num':
        s = ast[1].replace(/¯/g, '-');
        value = s.match(/^-?0x/i) ? parseInt(s, 16) : parseFloat(s);
        return function() {
