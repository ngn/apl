...
define(function(require) {
  ...
  maybeMakePervasive = function(f) {
    ...
    if (!((_ref1 = f.aplMetaInfo) != null ? _ref1.isPervasive : void 0)) {
      ...
      return withMetaInfoFrom(f, (F = function(b, a) {
        ...
        if (a != null) {
          while ((!isSimple(a)) && a.length === 1) {
            a = a[0];
          }
          while ((!isSimple(b)) && b.length === 1) {
            b = b[0];
          }
  ...
  builtins['set_⍬'] = function() {
    return die('Symbol zilde (⍬) is read-only.');
  };
  builtins['get_⎕IO'] = function() {
    return 0;
  };
  builtins['set_⎕IO'] = function(x) {
    if (x !== 0) {
