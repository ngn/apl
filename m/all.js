...
(function() {
  ...
  exec = function(aplCode, opts) {
    var ast, code, env, frame, k, result, v, x, _ref2, _ref3;
    if (opts == null) {
      opts = {};
    }
  ...
  compileAST = function(ast, opts) {
    ...
    if (!((VERB < ADVERB && ADVERB < CONJUNCTION))) {
      throw Error("\"assert VERB < ADVERB < CONJUNCTION # we are relying on this ordering below\" at src/compiler.coffee:30");
    }
    (categorizeLambdas = function(node) {
      ...
      switch (node[0]) {
        ...
        default:
          if (!(0)) {
            throw Error("\"else assert 0\" at src/compiler.coffee:43");
          }
      }
    })(ast);
    queue = [ast];
    while (queue.length) {
      ...
      visit = function(node) {
        ...
        switch (node[0]) {
          ...
          default:
            if (!(0)) {
              throw Error("\"assert 0\" at src/compiler.coffee:139");
            }
        }
      };
  ...
  prelude = (function() {
    var aplCode, ast, code, env, k, v, _ref2, _ref3;
    ...
    if (module === (typeof require !== "undefined" && require !== null ? require.main : void 0)) {
      (function() {
        ...
        if (file != null) {
          ...
          process.stdout.write("ngn apl 2013-11-30\n");
