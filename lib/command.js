...
(function() {
  var BTM, BTMLFT, BTMRGT, ColouredRect, LFT, RGT, Rect, TOP, TOPLFT, TOPRGT, blue, borderColour, colourId, cyan, decode, encode, exec, format, format0, functionColour, green, grey, hpad, isSimple, makeColour, numberColour, prod, purple, red, repeat, shapeOf, specialColour, stringColour, sum, vpad, yellow, _ref, _ref1, _ref2;

  exec = require('./compiler').exec;

  _ref = require('./helpers'), isSimple = _ref.isSimple, shapeOf = _ref.shapeOf, sum = _ref.sum, prod = _ref.prod, repeat = _ref.repeat;
  ...
  exports.main = function() {
    var a, argv, code, ctx, filename, fs, optimist, readline, rl;
