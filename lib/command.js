...
(function() {
  var BTM, BTMLFT, BTMRGT, ColouredRect, LFT, RGT, Rect, TOP, TOPLFT, TOPRGT, blue, borderColour, builtins, c, cps, createGetline, cyan, decode, encode, exec, format, format0, fs, functionColour, green, grey, hpad, inherit, isSimple, makeColour, numberColour, prod, purple, red, repeat, shapeOf, specialColour, stringColour, sum, trampoline, vpad, yellow, _ref, _ref1, _ref2;
  ...
  format0 = function(a) {
    var b, box, cb, colDimIndices, colDims, d, grid, h, i, j, m, mm, nCols, nRows, nsa, r, rb, rowDimIndices, rowDims, s, sa, strings, totalHeight, totalWidth, w, _i, _j, _k, _l, _len, _len1, _m, _n, _ref3;
