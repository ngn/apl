...
(function() {
  ...
  tokenize = (function() {
    ...
    return function(s) {
      ...
      b = a.toArray();
      _results = [];
      for (i = _i = 0, _ref2 = b.length, _ref3 = a.shape[1]; _ref3 > 0 ? _i < _ref2 : _i > _ref2; i = _i += _ref3) {
        _results.push({
          type: b[i],
  ...
  match = function(x, y) {
    var axis, r, t32, t33, t34, t35, t36, t37, t38, t39, t40, t41, t42, t43, t44, xi, yi, _i, _j, _k, _ref1, _ref2, _ref3;
    if (x instanceof APLArray) {
      if (!(y instanceof APLArray)) {
        ...
        for (axis = _j = 0, _ref2 = t39.length; 0 <= _ref2 ? _j < _ref2 : _j > _ref2; axis = 0 <= _ref2 ? ++_j : --_j) {
          if (!(t39[t36] === t40[t36])) {
            throw Error("\"for axis in [0...shape.length] then assert shape[axis] is shape1[axis]\" at src/array.coffee:49");
          }
        }
        if (!t32.empty()) {
          ...
          t35 = t33.offset;
          t44 = [];
          for (axis = _k = 0, _ref3 = t43; _k <= _ref3; axis = _k += 1) {
            t44.push(0);
          }
          while (true) {
            xi = t37[t34];
  ...
  approx = function(x, y) {
    var axis, r, t45, t46, t47, t48, t49, t50, t51, t52, t53, t54, t55, t56, t57, xi, yi, _i, _j, _k, _ref1, _ref2, _ref3;
    if (x instanceof APLArray) {
      if (!(y instanceof APLArray)) {
        return false;
      } else {
        ...
        for (axis = _j = 0, _ref2 = t52.length; 0 <= _ref2 ? _j < _ref2 : _j > _ref2; axis = 0 <= _ref2 ? ++_j : --_j) {
          if (!(t52[t49] === t53[t49])) {
            throw Error("\"for axis in [0...shape.length] then assert shape[axis] is shape1[axis]\" at src/array.coffee:49");
          }
        }
        if (!t45.empty()) {
          ...
          t48 = t46.offset;
          t57 = [];
          for (axis = _k = 0, _ref3 = t56; _k <= _ref3; axis = _k += 1) {
            t57.push(0);
          }
          while (true) {
            xi = t50[t47];
  ...
  depthOf = function(x) {
    var axis, r, t73, t74, t75, t76, t77, t78, t79, t80, y, _i, _ref1;
    if (x instanceof APLArray) {
      ...
      if (!t73.empty()) {
        ...
        t80 = t73.offset;
        t79 = [];
        for (axis = _i = 0, _ref1 = t76.length; _i < _ref1; axis = _i += 1) {
          t79.push(0);
        }
        while (true) {
          y = t75[t80];
  ...
  addVocabulary({
    '∪': function(omega, alpha) {
      var a, axis, data, t81, t82, t83, t84, t85, t86, t87, t88, t89, t90, t91, t92, t93, t94, t95, t96, x, _i, _j, _k, _len, _ref1, _ref2, _ref3;
      if (alpha) {
        data = [];
        _ref1 = [alpha, omega];
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          ...
          if (!t81.empty()) {
            ...
            t88 = t81.offset;
            t87 = [];
            for (axis = _j = 0, _ref2 = t84.length; _j < _ref2; axis = _j += 1) {
              t87.push(0);
            }
            while (true) {
              x = t83[t88];
        ...
        if (!t89.empty()) {
          ...
          t96 = t89.offset;
          t95 = [];
          for (axis = _k = 0, _ref3 = t92.length; _k < _ref3; axis = _k += 1) {
            t95.push(0);
          }
          while (true) {
            x = t91[t96];
  ...
  enlist = function(x, r) {
    var axis, t100, t101, t102, t103, t104, t105, t98, t99, y, _i, _ref1, _results;
    if (x instanceof APLArray) {
      t98 = x;
      if (!t98.empty()) {
        t100 = t98.data;
        ...
        t105 = t98.offset;
        t104 = [];
        for (axis = _i = 0, _ref1 = t101.length; _i < _ref1; axis = _i += 1) {
          t104.push(0);
        }
        _results = [];
        while (true) {
  ...
  addVocabulary({
    '⍎': function(omega, alpha) {
      var axis, c, s, t113, t114, t115, t116, t117, t118, t119, t120, _i, _ref2;
      if (alpha) {
        return nonceError();
      } else {
        s = '';
        ...
        if (!t113.empty()) {
          ...
          t120 = t113.offset;
          t119 = [];
          for (axis = _i = 0, _ref2 = t116.length; _i < _ref2; axis = _i += 1) {
            t119.push(0);
          }
          while (true) {
            c = t115[t120];
  ...
  grade = function(omega, alpha, direction) {
    var axis, h, indices, t123, t124, t125, t126, t127, t128, t129, x, _i, _j, _ref2, _ref3, _results;
    h = {};
    if (alpha) {
      if (!alpha.shape.length) {
        rankError();
      ...
      if (!t123.empty()) {
        ...
        t129 = t123.offset;
        indices = [];
        for (axis = _i = 0, _ref2 = t126.length; _i < _ref2; axis = _i += 1) {
          indices.push(0);
        }
        while (true) {
          x = t125[t129];
    ...
    return new APLArray((function() {
      _results = [];
      for (var _j = 0, _ref3 = omega.shape[0]; 0 <= _ref3 ? _j < _ref3 : _j > _ref3; 0 <= _ref3 ? _j++ : _j--){ _results.push(_j); }
      return _results;
  ...
  addVocabulary({
    '⍳': function(omega, alpha) {
      ...
      if (alpha) {
        ...
        return omega.map(function(x) {
          var axis, e, indices, rank, t130, t131, t132, t133, t134, t135, t136, y, _i, _ref2;
          try {
            rank = alpha.shape;
            t130 = alpha;
            if (!t130.empty()) {
              ...
              t136 = t130.offset;
              indices = [];
              for (axis = _i = 0, _ref2 = t133.length; _i < _ref2; axis = _i += 1) {
                indices.push(0);
              }
              while (true) {
                y = t132[t136];
  ...
  addVocabulary({
    '⊂': function(omega, alpha, axes) {
      var axis, data, i, indices, p, resultAxes, shape, stride, t146, t147, t148, t149, t150, t151, unitShape, unitStride, x, _i, _j, _ref2, _ref3, _results;
      if (!(!alpha)) {
      ...
      if (!t146.empty()) {
        ...
        p = t146.offset;
        indices = [];
        for (axis = _j = 0, _ref3 = t149.length; _j < _ref3; axis = _j += 1) {
          indices.push(0);
        }
        while (true) {
          x = t148[p];
  ...
  addVocabulary({
    '⍴': function(omega, alpha) {
      var a, axis, data, e, n, t159, t160, t161, t162, t163, t164, t165, t166, tmp158, x, _i, _j, _len, _ref2;
      if (alpha) {
        if (alpha.shape.length > 1) {
          rankError();
        }
        ...
        if (!n) {
          ...
          try {
            ...
            if (!t159.empty()) {
              ...
              t166 = t159.offset;
              t165 = [];
              for (axis = _j = 0, _ref2 = t162.length; _j < _ref2; axis = _j += 1) {
                t165.push(0);
              }
              while (true) {
                x = t161[t166];
  ...
  addVocabulary({
    '⌷': squish = function(omega, alpha, axes) {
      var a, data, p, subscriptShapes, subscripts, u, x, _i, _ref2, _ref3, _ref4;
      if (typeof omega === 'function') {
        return function(x, y) {
      ...
      if (all((function() {
        ...
        p = omega.offset;
        for (a = _i = 0, _ref3 = subscripts.length; _i < _ref3; a = _i += 1) {
    ...
    _substitute: function(args) {
      var a, alpha, axes, i, indexShape, n, omega, p, q, r, subscriptShapes, subscripts, u, value, x, _i, _j, _len, _ref2, _ref3, _ref4, _ref5;
      _ref2 = (function() {
      ...
      _ref3 = prepareForIndexing(omega, alpha, axes), subscripts = _ref3[0], subscriptShapes = _ref3[1];
      indexShape = (_ref4 = []).concat.apply(_ref4, subscriptShapes);
      ...
      p = 0;
      for (a = _j = 0, _ref5 = subscripts.length; _j < _ref5; a = _j += 1) {
  ...
  prepareForIndexing = function(omega, alpha, axes) {
    var alphaItems, axis, d, i, subscriptShapes, subscripts, tmp171, tmp172, x, _i, _j, _k, _l, _len, _len1, _m, _ref2, _ref3, _ref4, _ref5, _results, _results1;
    ...
    for (i = _l = 0, _ref4 = subscripts.length; _l < _ref4; i = _l += 1) {
  ...
  addVocabulary({
    '⍉': function(omega, alpha) {
      var i, n, shape, stride, tmp173, u, x, _i, _j, _len, _len1, _ref2;
      if (alpha) {
        if (alpha.shape.length > 1) {
          rankError();
        }
