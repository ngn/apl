...
define(['../lib/parser', './helpers'], function(parser, helpers) {
  var assert, assignParents, builtinVarInfo, builtins, closestScope, compile, createHash, die, exec, hex4, inherit, isArray, jsName, ord, parse, predefinedNames, printAST, repr, resolveSeqs, toJavaScript;
  parse = parser.parse;
