...
define(['./compiler', './helpers', 'optimist'], function(compiler, helpers, optimist) {
  var BTM, BTMLFT, BTMRGT, ColouredRect, LFT, RGT, Rect, TOP, TOPLFT, TOPRGT, blue, borderColour, colourId, cyan, decode, die, encode, exec, format, format0, functionColour, green, grey, hpad, isSimple, main, makeColour, numberColour, prod, purple, red, repeat, shapeOf, specialColour, stringColour, sum, vpad, yellow, _ref, _ref1;
  exec = compiler.exec;
  ...
  main = function() {
    var a, argv, characterInput, code, ctx, filename, fs, readline, rl;
