...
define(['./parser', './vocabulary', './complex', './helpers'], function(parser, _arg, _arg1, helpers) {
  var Complex, all, assert, assignParents, closestScope, compile, die, exec, inherit, nodes, resolveSeqs, toJavaScript, vocabulary;
      ...
      visit = function(node) {
        ...
        switch (node[0]) {
          ...
          case 'assign':
            ...
            assert(node[1][0] === 'sym', 'Compound assignment is not supported.');
            name = node[1][1];
