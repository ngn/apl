...
(function() {
  var PI, abs, acos, ambivalent, array, asin, assert, atan, bool, builtins, catenate, ceil, compressOrReplicate, cos, cps, cpsify, def, depthOf, die, dyadic, endOfBuiltins, exp, expand, floor, grade, infixOperator, isSimple, log, match, max, min, monadic, num, outerProduct, pervasive, postfixOperator, pow, prefixOperator, prod, prototypeOf, random, reduce, repeat, repr, reverse, round, scan, shapeOf, sin, sqrt, sum, tan, tmp, withPrototype, withPrototypeCopiedFrom, withShape, _ref,
    __slice = [].slice,
  ...
  prefixOperator = function() {
    var a;
    a = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return (def.apply(null, [tmp.monadic].concat(__slice.call(a)))).isPrefixOperator = true;
  };

  postfixOperator = function() {
    var a;
    a = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return (def.apply(null, [tmp.monadic].concat(__slice.call(a)))).isPostfixOperator = true;
  };

  infixOperator = function() {
    var a;
    a = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return (def.apply(null, [tmp.dyadic].concat(__slice.call(a)))).isInfixOperator = true;
  };
  ...
  ambivalent = function(symbol, f1, f2) {
    return function() {
      ...
      return (typeof (b != null ? b[symbol] : void 0) === 'function' ? b[symbol] : typeof (a != null ? a[symbol] : void 0) === 'function' ? a[symbol] : a != null ? f2 : f1).apply(null, [b, a].concat(__slice.call(args)));
    };
  };

  endOfBuiltins = function() {
    var f, k, _ref1, _ref2, _ref3;
    _ref1 = tmp.monadic;
    for (k in _ref1) {
      f = _ref1[k];
      if (!tmp.dyadic[k]) {
    ...
    for (k in _ref3) {
      f = _ref3[k];
      if (tmp.dyadic[k]) {
        builtins[k] = ambivalent(k, f, tmp.dyadic[k]);
      }
    }
    return tmp = null;
  };
  ...
  monadic('+', 'Add', pervasive(function(x) {
    return x;
  }));

  dyadic('+', 'Conjugate', pervasive(function(y, x) {
    return x + y;
  }));
  ...
  monadic('⍳', 'Index generate', function(x) {
  ...
  monadic('!', 'Factorial', pervasive(function(a) {
    var i, n, r, _i;
    n = a = floor(num(a));
    r = 1;
    if (n > 1) {
  ...
  infixOperator('.', 'Inner product', function(f, g) {
    var F, G;
    F = reduce(f);
    G = outerProduct(g);
    return function(b, a) {
