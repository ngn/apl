...
(function() {
  var compile, firstPass, globalVarInfo, inherit, isArray, parse, printAST, repr, secondPass;
  ...
  secondPass = function(ast) {
    ...
    visit = function(node) {
      ...
      switch (node[0]) {
        ...
        case 'sym':
          return "stack.push(ctx[" + (repr(node[1])) + "]);";
        case 'lambda':
        ...
        case 'num':
          ...
          if (a.length === 1) {
            return "stack.push(" + a[0] + ");";
          } else {
            return "stack.push(new Complex(" + a[0] + ", " + a[1] + "));";
          }
          break;
        case 'index':
