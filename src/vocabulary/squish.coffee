...
#     (23 54 38)[3]                         ⍝ throws 'INDEX ERROR'
#     (23 54 38)[¯1]                        ⍝ throws 'INDEX ERROR'
#     (23 54 38)[0 2]                       ⍝ returns 23 38
#     (2 3 ⍴ 100 101 102 110 111 112)[1;2]  ⍝ returns 112
#     (2 3 ⍴ 100 101 102 110 111 112)[1;¯1] ⍝ throws 'INDEX ERROR'
#     (2 3 ⍴ 100 101 102 110 111 112)[10;1] ⍝ throws 'INDEX ERROR'
