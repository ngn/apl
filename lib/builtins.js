(function() {
  var ambivalent, arrayValueOf, assert, booleanValueOf, builtins, catenate, compressOrReplicate, cps, cpsify, depthOf, dyadic, infixOperator, isSimple, match, monadic, named, numericValueOf, outerProduct, overloadable, pervasive, postfixOperator, prefixOperator, prod, prototypeOf, reduce, repeat, reverse, shapeOf, sum, withPrototype, withPrototypeCopiedFrom, withShape, _ref;
