...
(function() {
  var PI, abs, acos, ambivalent, array, asin, assert, atan, bool, builtins, catenate, ceil, compressOrReplicate, cos, cps, cpsify, depthOf, die, dyadic, exp, expand, floor, grade, infixOperator, isSimple, log, match, max, min, monadic, named, num, outerProduct, overloadable, pervasive, postfixOperator, pow, prefixOperator, prod, prototypeOf, random, reduce, repeat, repr, reverse, round, scan, shapeOf, sin, sqrt, sum, tan, withPrototype, withPrototypeCopiedFrom, withShape, _ref,
    __slice = [].slice,
  ...
  dyadic(pervasive(overloadable(named('+', function(y, x) {
    return x + y;
  }))));
  ...
  monadic(overloadable(named('⍳', function(x) {
    var _i, _ref1, _results;
    return (function() {
      _results = [];
      for (var _i = 0, _ref1 = floor(num(x)); 0 <= _ref1 ? _i < _ref1 : _i > _ref1; 0 <= _ref1 ? _i++ : _i--){ _results.push(_i); }
      return _results;
    }).apply(this);
  })));

  dyadic(overloadable(named('⍳', function(b, a) {
  ...
  dyadic(overloadable(named('?', function(y, x) {
  ...
  dyadic(pervasive(overloadable(named('○', function(x, i) {
    var ex;
    switch (i) {
      case 0:
        return sqrt(1 - x * x);
  ...
  dyadic(pervasive(overloadable(named('!', function(b, a) {
    var i, k, n, r, _i;
    k = a = floor(num(a));
    n = b = floor(num(b));
    if (!((0 <= k && k <= n))) {
  ...
  dyadic(overloadable(named('≡', match = function(b, a) {
