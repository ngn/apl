(function() {
  var BTM, BTMLFT, BTMRGT, LFT, RGT, TOP, TOPLFT, TOPRGT, ambivalent, arrayValueOf, booleanValueOf, builtins, catenate, compressOrReplicate, cps, cpsify, depthOf, dyadic, format, format0, hpad, infixOperator, isSimple, match, monadic, niladic, numericValueOf, outerProduct, pervasive, postfixOperator, prefixOperator, prod, reduce, repeat, reverse, shapeOf, sum, vpad, withShape, _ref;
