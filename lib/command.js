(function() {
  var BTM, BTMLFT, BTMRGT, LFT, RGT, TOP, TOPLFT, TOPRGT, builtins, cps, createGetline, exec, format, format0, fs, hpad, inherit, isSimple, prod, repeat, shapeOf, sum, trampoline, vpad, _ref, _ref2;
  fs = require('fs');
