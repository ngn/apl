...
nt('body', [o('', "$$ = ['body']"), o('guard', "$$ = ['body', $1]"), o('body NEWLINE', "$$ = $1"), o('body SEPARATOR', "$$ = $1"), o('body NEWLINE guard', "($$ = $1).push($3)"), o('body SEPARATOR guard', "($$ = $1).push($3)")]);
...
nt('indices', [o('expr', "$$ = [$1]"), o(';', "$$ = [null]"), o('; expr', "$$ = [null, $2]"), o('indices ; expr', "($$ = $1).push($3)"), o('indices ;', "($$ = $1).push(null)")]);
