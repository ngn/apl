...
define(['./helpers'], function(helpers) {
  var PI, abs, acos, ambivalent, array, asin, assert, atan, bool, builtins, catenate, ceil, compressOrReplicate, cos, def, depthOf, die, dyadic, endOfBuiltins, exp, expand, floor, grade, infixOperator, inherit, isSimple, log, match, max, maybeMakePervasive, min, monadic, num, outerProduct, overloadable, pervasive, postfixOperator, pow, prefixOperator, prod, prototypeOf, random, reduce, repeat, repr, reverse, round, scan, shapeOf, sin, sqrt, sum, tan, tmp, withMetaInfoFrom, withPrototype, withPrototypeCopiedFrom, withShape;
  assert = helpers.assert, die = helpers.die, inherit = helpers.inherit, isSimple = helpers.isSimple, shapeOf = helpers.shapeOf, withShape = helpers.withShape, sum = helpers.sum, prod = helpers.prod, repeat = helpers.repeat, prototypeOf = helpers.prototypeOf, withPrototype = helpers.withPrototype, withPrototypeCopiedFrom = helpers.withPrototypeCopiedFrom;
