...
(function() {
  var assert, assignParents, builtinVarInfo, builtins, closestScope, compile, createHash, die, helpers, hex4, inherit, isArray, jsName, ord, parse, predefinedNames, printAST, repr, resolveSeqs, toJavaScript, _ref;
  ...
  exports.exec = function(source, opts) {
    var h, k, v, _ref1;
    h = inherit(builtins);
