  ...
  apl.ws = function(opts) {
    ...
    if (opts["in"]) {
      ctx['get_⎕'] = ctx['get_⍞'] = function() {
        ...
        s = opts["in"]();
        if (!(typeof s === 'string')) {
          throw Error("\"if opts.in then ctx['get_⎕'] = ctx['get_⍞'] = -> s = opts.in(); assert typeof s is 'string'; new APLArray s\" at /tmp/apl/src/apl.coffee:65");
        }
    ...
    if (module === (typeof require !== "undefined" && require !== null ? require.main : void 0)) {
      (function() {
        ...
        if (file != null) {
          ...
          process.stdout.write("ngn apl 2014-01-07\n");
