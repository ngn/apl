...
(function() {
  ...
  overloadable = function(symbol, f) {
    ...
    F = function() {
      ...
      if (typeof (b != null ? b[symbol] : void 0) === 'function') {
        ...
        return a[symbol].apply(a, [a].concat(__slice.call(args)));
      } else {
  ...
  endOfBuiltins = function() {
    ...
    for (k in _ref3) {
      f = _ref3[k];
      if (tmp.dyadic[k]) {
        builtins[k] = overloadable(k, ambivalent(k, f, tmp.dyadic[k]));
      }
    }
    return tmp = null;
  };
