(function() {
  var ambivalent, arrayValueOf, assert, booleanValueOf, builtins, catenate, compressOrReplicate, cps, cpsify, depthOf, dyadic, infixOperator, isSimple, match, monadic, named, numericValueOf, outerProduct, pervasive, postfixOperator, prefixOperator, prod, prototypeOf, reduce, repeat, reverse, shapeOf, sum, withPrototype, withPrototypeCopiedFrom, withShape, _ref;
  ...
  monadic(named('+', function(a) {
    return a;
  }));
  dyadic(pervasive(named('+', function(x, y) {
    return x + y;
  })));
  monadic(pervasive(named('−', function(x) {
    return -x;
  })));
  dyadic(pervasive(named('−', function(x, y) {
    return x - y;
  ...
  dyadic(pervasive(named('○', function(i, x) {
    var ex;
    switch (i) {
      case 0:
  ...
  monadic(pervasive(named('!', function(a) {
    var i, n, r;
  ...
  dyadic(pervasive(named('!', function(a, b) {
    var i, k, n, r;
  ...
  monadic(named('≡', depthOf = function(a) {
    var r, x, _i, _len;
    if (isSimple(a)) {
      return 0;
    }
  ...
  dyadic(named('≡', match = function(a, b) {
  ...
  monadic(named('⌽', reverse = function(a, _, axis) {
  ...
  monadic(named('⊖', function(a, _, axis) {
    if (axis == null) {
      axis = 0;
    }
