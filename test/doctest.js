...
var actual, code, d, exec, expected, expectedErrorMessage, f, fail, fs, i, lastTestTimestamp, line, lines, m, match, message, nFailed, nTests, outcome, path, repr, t0, trim, vocabulary, _i, _len, _ref;
...
vocabulary = require('../lib/vocabulary').vocabulary;
