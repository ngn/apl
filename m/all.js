...
var APLArray, DomainError, LengthError, assert, isInt, prod, strideForShape, _ref, _ref1;
...
var SyntaxError, all, assert, compile, compilerError, lhsToJavaScript, nodes, parser, resolveExprs, toJavaScript, vocabulary, _ref;

parser = require('./parser');

vocabulary = require('./vocabulary');

_ref = require('./helpers'), assert = _ref.assert, all = _ref.all;
...
var Complex, DomainError, assert, complexify, simplify;
...
this.parse = function(aplCode, opts) {
  var consume, demand, parseAssignments, parseBody, parseExpr, parseIndexable, parseIndices, parseItem, parserError, result, token, tokenStream;
  if (opts == null) {
    opts = {};
  }
  ...
  parseBody = function() {
    ...
    while (true) {
      ...
      if (consume(':')) {
        node = ['guard', node, parseAssignments()];
      }
      body.push(node);
    }
  };
  parseAssignments = function() {
    ...
    node = parseExpr();
    if (consume('←')) {
      return ['assign', node, parseAssignments()];
    } else {
      return node;
    }
  };
  parseExpr = function() {
    ...
    items = (function() {
      var _ref, _results;
      _results = [];
      while ((_ref = token.type) !== '←' && _ref !== ')' && _ref !== ']' && _ref !== '}' && _ref !== ':' && _ref !== ';' && _ref !== 'separator' && _ref !== 'newline' && _ref !== 'eof') {
        _results.push(parseItem());
      }
      return _results;
    })();
    if (items.length === 1) {
...
var APLArray, DomainError, LengthError, NonceError, RankError, adverb, assert, expand, isInt, repeat, scan, _ref, _ref1;

APLArray = require('../array').APLArray;

_ref = require('../helpers'), assert = _ref.assert, isInt = _ref.isInt, repeat = _ref.repeat;
...
var APLArray, assert, conjunction, each, enclose, innerProduct, jot, outerProduct, reduce;
...
var APLArray, LengthError, adverb, arrayEquals, assert;
...
var APLArray, Beta, DomainError, isInt, lnΓ, pervasive, real, withIdentity, Γ, _ref;
...
var APLArray, RankError, assert, conjunction, withIdentity, _ref;
...
var APLArray, Complex, DomainError, RankError, aka, assert, bool, isInt, match, negate, pervasive, real, withIdentity, _ref, _ref1, _ref2;
...
var assert, conjunction, isInt, _ref;
...
var APLArray, DomainError, LengthError, RankError, adverb, assert, compressOrReplicate, isInt, reduce, repeat, _ref, _ref1;
...
var APLArray, DomainError, IndexError, LengthError, RankError, assert, isInt, prepareForIndexing, prod, repeat, squish, _ref, _ref1;
...
var APLArray, Complex, DomainError, LengthError, RankError, SyntaxError, approx, assert, complexify, eps, isInt, match, meta, multiplicitySymbol, numApprox, _ref, _ref1, _ref2,
  __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
...
_ref2 = require('../complex'), Complex = _ref2.Complex, complexify = _ref2.complexify;
...
this.pervasive = function(_arg) {
  ...
  pervadeDyadic = dyad ? function(x, y) {
    var axis, r, tx, ty, xi, yi, _i, _ref3;
...
this.approx = approx = function(x, y) {
  var axis, r, _i, _ref3, _ref4, _ref5;
  if (x instanceof APLArray) {
    if (!(y instanceof APLArray)) {
      return false;
    } else {
    ...
    if (y instanceof APLArray) {
      ...
      if (x instanceof Complex) {
        ...
        return (_ref4 = (_ref5 = typeof x['≡'] === "function" ? x['≡'](y) : void 0) != null ? _ref5 : typeof y['≡'] === "function" ? y['≡'](x) : void 0) != null ? _ref4 : x === y;
      }
    }
  }
};
