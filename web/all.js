...
this.main = function() {
  var a, aplCode, argv, b, ctx, filename, jsCode, k, knownOptions, opts, vocabulary;
...
var SyntaxError, all, assert, compile, compilerError, nodes, parser, resolveExprs, toJavaScript, vocabulary, _ref;
...
var k, moduleName, moduleNames, name, v, _base, _base1, _base2, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3;
...
for (_i = 0, _len = moduleNames.length; _i < _len; _i++) {
  moduleName = moduleNames[_i];
  _ref = require("./vocabulary/" + moduleName);
  for (k in _ref) {
    v = _ref[k];
    this[k] = v;
    if (typeof v === 'function') {
...
var APLArray, Complex, DomainError, complexify, div, exp, ln, mult, pervasive, simplify, withIdentity, _ref, _ref1;

_ref = require('./vhelpers'), pervasive = _ref.pervasive, withIdentity = _ref.withIdentity;

_ref1 = require('../complex'), Complex = _ref1.Complex, complexify = _ref1.complexify, simplify = _ref1.simplify;

DomainError = require('../errors').DomainError;

APLArray = require('../array').APLArray;

this['+'] = withIdentity(APLArray.zero, pervasive({
  monad: function(x) {
    if (typeof x === 'number') {
      return x;
    } else if (x instanceof Complex) {
...
this['*'] = withIdentity(APLArray.one, pervasive({
  ...
  dyad: function(y, x) {
    var _ref2;
    if ((typeof x === (_ref2 = typeof y) && _ref2 === 'number') && x >= 0) {
      return Math.pow(x, y);
    } else {
      x = complexify(x);
      y = complexify(y);
...
var APLArray, DomainError, LengthError, NonceError, RankError, assert, expand, isInt, repeat, scan, _ref, _ref1;
...
var APLArray, Complex, depthOf, eq, match, numeric, pervasive, withIdentity, _ref;

APLArray = require('../array').APLArray;

_ref = require('./vhelpers'), pervasive = _ref.pervasive, numeric = _ref.numeric, match = _ref.match, withIdentity = _ref.withIdentity;
...
var APLArray, numeric, pervasive, withIdentity, _ref;

_ref = require('./vhelpers'), pervasive = _ref.pervasive, numeric = _ref.numeric, withIdentity = _ref.withIdentity;

APLArray = require('../array').APLArray;

this['⌊'] = withIdentity(new APLArray([Infinity], []), pervasive({
...
}, "vocabulary/innerproduct": function(exports, require, module) {// Generated by CoffeeScript 1.6.3
...
var APLArray, DomainError, RankError, assert, bool, isInt, match, negate, numeric, pervasive, withIdentity, _ref, _ref1, _ref2;

APLArray = require('../array').APLArray;

_ref = require('../errors'), RankError = _ref.RankError, DomainError = _ref.DomainError;

_ref1 = require('./vhelpers'), numeric = _ref1.numeric, pervasive = _ref1.pervasive, bool = _ref1.bool, match = _ref1.match, withIdentity = _ref1.withIdentity;
...
}, "vocabulary/outerproduct": function(exports, require, module) {// Generated by CoffeeScript 1.6.3
var APLArray, assert;
...
var APLArray, DomainError, NonceError, RankError, prod, repeat, _ref, _ref1;
...
this['↑'] = function(omega, alpha) {
  var a, axis, copyIndices, copyShape, data, i, mustCopy, offset, p, q, shape, shapes, stride, x, _i, _j, _k, _l, _len, _len1, _len2, _len3, _m, _ref2;
  if (alpha) {
    if (alpha.shape.length > 1) {
      throw RankError();
    }
    ...
    if (omega.shape.length === 0) {
      ...
      shape = shapes.reduce(function(a, b) {
        var _n, _ref3, _results;
        if (a.length !== b.length) {
          throw NonceError('Mix of different ranks not implemented');
        }
        _results = [];
        for (i = _n = 0, _ref3 = a.length; 0 <= _ref3 ? _n < _ref3 : _n > _ref3; i = 0 <= _ref3 ? ++_n : --_n) {
      ...
      data = [];
      omega.each(function(x) {
        return data = data.concat(x.toArray());
      });
...
this.withIdentity = function(identity, f) {
  (f.aplMetaInfo != null ? f.aplMetaInfo : f.aplMetaInfo = {}).identity = identity;
  return f;
};
