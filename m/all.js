...
var APLArray, APLError, Beta, Complex, DYA, DomainError, GET, IndexError, JEQ, LAM, LDC, LengthError, MON, NonceError, POP, RET, RankError, SET, SPL, SyntaxError, VEC, addVocabulary, adverb, aka, all, apl, approx, arrayEquals, bool, catenate, compile, complexify, compressOrReplicate, conjunction, contains, deal, depthOf, enlist, eps, eq, exec, exp, expand, format, getAxisList, grade, innerProduct, lnΓ, match, meta, mix, multiplicitySymbol, negInt, negate, numApprox, numeric, outerProduct, parse, pervasive, prepareForIndexing, prod, real, reduce, repeat, roll, rotate, scan, simplify, smallFactorials, squish, strideForShape, take, tokenDefs, tokenize, vm, vocabulary, withIdentity, Γ, λ, _ref,
...
vm = function(_arg) {
  ...
  if (!(code instanceof Array)) {
    throw Error("\"assert code instanceof Array\" at src/vm.coffee:18");
  }
  if (!(env instanceof Array)) {
    throw Error("\"assert env instanceof Array\" at src/vm.coffee:19");
  }
  for (_i = 0, _len = env.length; _i < _len; _i++) {
    frame = env[_i];
    if (!(frame instanceof Array)) {
      throw Error("\"for frame in env then assert frame instanceof Array\" at src/vm.coffee:20");
    }
  }
  if (stack == null) {
    stack = [];
  ...
  while (true) {
    switch (code[pc++]) {
      ...
      case RET:
        ...
        _ref2 = stack.splice(-3, 2), pc = _ref2[0], env = _ref2[1];
        break;
      case POP:
        stack.pop();
        break;
...
compile = function(aplCode, opts) {
  var ast, err, node, queue, render, renderLHS, scopeNode, vars, visit, visitLHS, _i, _len, _ref1;
  if (opts == null) {
    opts = {};
  }
  ...
  (function() {
    ...
    for (k in _ref1) {
      ...
      if (typeof v === 'function') {
        varInfo.type = 'F';
        if ((_ref2 = v.aplMetaInfo) != null ? _ref2.isPostfixAdverb : void 0) {
  ...
  while (queue.length) {
    ...
    visit = function(node) {
      var a, c, h, i, j, name, r, t, v, x, _i, _j, _len, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      ...
      switch (node[0]) {
        ...
        case 'index':
          ...
          for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
            c = _ref2[_i];
            if (c) {
              (t = visit(c)).type === 'X' || err(node, 'Only expressions of type data can be used as an index.');
            }
          }
          return visit(node[1]);
        case 'expr':
