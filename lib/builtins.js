...
define(['./helpers'], function(helpers) {
  ...
  monadic('⍳', 'Index generate', function(a) {
    ...
    indices = (function() {
      ...
      _results = [];
      for (i = _j = 0, _ref = a.length; _j < _ref; i = _j += 1) {
        _results.push(0);
      }
      return _results;
    })();
  ...
  builtins['set_⎕IO'] = function() {
    throw Error('Assignment to the index origin (⎕IO) is not supported.');
  };
  reduce = function(f, _, axis) {
    ...
    return function(b, a) {
      var i, invokedAsMonadic, isBackwards, items, j, k, n, r, sItem, sb, x, _i, _j, _ref;
