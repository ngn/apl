...
var APLArray, APLError, Beta, Complex, DYA, DomainError, GET, IndexError, JEQ, LAM, LDC, LengthError, MON, NonceError, POP, RET, RankError, SET, SPL, SyntaxError, VEC, addVocabulary, adverb, aka, all, apl, approx, arrayEquals, bool, catenate, compile, compileAST, complexify, compressOrReplicate, conjunction, contains, deal, depthOf, enlist, eps, eq, exec, execInternal, exp, expand, format, getAxisList, grade, innerProduct, lnΓ, match, meta, mix, multiplicitySymbol, negInt, negate, numApprox, numeric, outerProduct, parse, pervasive, prelude, prepareForIndexing, prod, real, reduce, repeat, roll, rotate, scan, simplify, smallFactorials, squish, strideForShape, take, tokenDefs, tokenize, vm, vocabulary, withIdentity, Γ, λ, _ref,
...
compileAST = function(ast, opts) {
  var err, node, queue, render, renderLHS, scopeNode, vars, visit, visitLHS, _i, _len, _ref1;
  if (opts == null) {
    opts = {};
  }
  ast.scopeDepth = 0;
