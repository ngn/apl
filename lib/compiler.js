...
define(function(require) {
  ...
  resolveSeqs = function(ast) {
    ...
    while (queue.length) {
      ...
      visit = function(node) {
        var a, c, child, i, j, name, t, t1, x, _i, _j, _len, _len1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
        switch (node[0]) {
          case 'body':
  ...
  compile = function(aplCode) {
    return toJavaScript(nodes(aplCode));
  };
  exec = function(aplCode, opts) {
    if (opts == null) {
      opts = {};
    }
    return (new Function("var _ = arguments[0];\n" + (compile(aplCode))))(inherit(builtins, opts.extraContext));
  };
  return {
    nodes: nodes,
    compile: compile,
