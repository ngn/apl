(function() {
  var ambivalent, arrayValueOf, booleanValueOf, builtins, catenate, compressOrReplicate, cps, cpsify, depthOf, dyadic, infixOperator, isSimple, match, monadic, numericValueOf, outerProduct, pervasive, postfixOperator, prefixOperator, prod, reduce, repeat, reverse, shapeOf, sum, withShape, _ref;
  ...
  _ref = require('./helpers'), cps = _ref.cps, cpsify = _ref.cpsify, isSimple = _ref.isSimple, shapeOf = _ref.shapeOf, sum = _ref.sum, prod = _ref.prod, repeat = _ref.repeat;
