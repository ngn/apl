...
(function() {
  ...
  (function() {
    var k, v, _ref1, _ref2, _ref3, _ref4, _results;
    builtinVarInfo['∇'] = {
      type: 'F'
    };
    _results = [];
    for (k in builtins) {
      ...
      builtinVarInfo[k] = typeof v !== 'function' ? {
        type: 'X'
      } : ((_ref1 = v.aplMetaInfo) != null ? _ref1.isNiladicFunction : void 0) ? {
        type: 'F',
        isNiladicFunction: true
      } : ((_ref2 = v.aplMetaInfo) != null ? _ref2.isPrefixOperator : void 0) ? {
        type: 'F',
        isPrefixOperator: true
      } : ((_ref3 = v.aplMetaInfo) != null ? _ref3.isPostfixOperator : void 0) ? {
        type: 'F',
        isPostfixOperator: true
      } : ((_ref4 = v.aplMetaInfo) != null ? _ref4.isInfixOperator : void 0) ? {
        type: 'F',
  ...
  resolveSeqs = function(ast) {
    ...
    while (queue.length) {
      ...
      visit = function(node) {
        var a, c, child, h, i, j, name, t, t1, v, _i, _j, _k, _len, _len1, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
        switch (node[0]) {
          case 'body':
          ...
          case 'seq':
            ...
            while (--i >= 0) {
              if (h[i + 1].isInfixOperator && (h[i].type === 'F' || h[i + 2].type === 'F')) {
                [].splice.apply(a, [i, (i + 3) - i].concat(_ref7 = [['infixOperator'].concat(a.slice(i, i + 3))])), _ref7;
            ...
            while (i < a.length - 1) {
              if (h[i].type === 'F' && h[i + 1].isPostfixOperator) {
                [].splice.apply(a, [i, (i + 2) - i].concat(_ref9 = [['postfixOperator'].concat(a.slice(i, i + 2))])), _ref9;
            ...
            while (--i >= 0) {
              if (h[i].isPrefixOperator && h[i + 1].type === 'F') {
                [].splice.apply(a, [i, (i + 2) - i].concat(_ref11 = [['prefixOperator'].concat(a.slice(i, i + 2))])), _ref11;
            ...
            a[0].parent = null;
            _ref22 = node.slice(1);
            for (_k = 0, _len1 = _ref22.length; _k < _len1; _k++) {
              c = _ref22[_k];
              if (c) {
                c.parent = node;
              }
  ...
  toJavaScript = function(ast) {
    var k, s, v, visit;
    visit = function(node) {
      var a, c, child, d, getter, n, name, r, s, setter, v, x, _ref1, _ref2;
      switch (node[0]) {
        case 'body':
          r = '';
          if (node.length === 1) {
        ...
        case 'sym':
          ...
          } else if (((_ref2 = (v = closestScope(node).vars[getter = "get_" + name])) != null ? _ref2.type : void 0) === 'F') {
            v.used = true;
