(function() {
  ...
  define(['./parser', './vocabulary', './complex', './helpers'], function(parser, vocabulary, _arg, helpers) {
    var Complex, all, assert, assignParents, closestScope, compile, die, exec, inherit, nodes, resolveExprs, toJavaScript;
    Complex = _arg.Complex;
    ...
    resolveExprs = function(ast, opts) {
      var h, k, m, node, queue, scopeCounter, scopeNode, v, vars, visit, _i, _j, _len, _len1, _ref, _ref1;
      if (opts == null) {
        opts = {};
      }
      ast.vars = {
      ...
      while (queue.length) {
        ...
        visit = function(node) {
          var a, c, child, i, j, name, t, t1, x, _j, _k, _len1, _len2, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
          switch (node[0]) {
            case 'body':
            ...
            case 'expr':
              ...
              while (--i >= 0) {
                if (h[i + 1].isConjunction && (h[i].type === 'F' || h[i + 2].type === 'F')) {
                  [].splice.apply(a, [i, (i + 3) - i].concat(_ref6 = [['conjunction'].concat(a.slice(i, i + 3))])), _ref6;
              ...
              while (i < a.length - 1) {
                if (h[i].type === 'F' && h[i + 1].isPostfixAdverb) {
                  [].splice.apply(a, [i, (i + 2) - i].concat(_ref8 = [['postfixAdverb'].concat(a.slice(i, i + 2))])), _ref8;
    ...
    toJavaScript = function(ast) {
      var visit;
      visit = function(node) {
        var a, c, child, d, i, n, name, s, v, vars, x, _i, _len, _ref, _ref1, _ref2;
        switch (node[0]) {
          case 'body':
            if (node.length === 1) {
              return 'return [];\n';
