...
(function() {
  ...
  spread = function(a, i, m, n) {
    var j, _i;
    if (a instanceof Array) {
      for (j = _i = m; _i < n; j = _i += 1) {
        a[i + j] = a[i + j % m];
      }
    } else {
      a = a.subarray(i, i + n);
  ...
  addVocabulary({
    '⍳': function(omega, alpha) {
      var A, a, d, data, i, itemData, itemShape, itemStride, j, m, n, p, tmp145, u, _i, _j, _k, _l, _len, _m, _ref1, _ref2;
      if (alpha) {
        if (alpha.shape.length !== 1) {
          rankError();
        }
        ...
        if (!n) {
          ...
          data = n <= 0x100 ? new Uint8Array(n) : (n <= 0x10000 ? new Uint16Array(n) : void 0, n <= 0x100000000 ? new Uint32Array(n) : domainError());
          for (i = _j = 0; _j < n; i = _j += 1) {
            data[i] = i;
          }
        } else {
          m = Math.max.apply(Math, a);
          A = m <= 0x100 ? Uint8Array : (m <= 0x10000 ? Uint16Array : void 0, m <= 0x100000000 ? Uint32Array : domainError());
  ...
  deal = function(omega, alpha) {
    var h, i, j, r, tmp155, tmp156, _i, _j, _ref1, _results;
    alpha = alpha.unwrap();
    omega = omega.unwrap();
    if (!(((tmp155 = omega) === ~~tmp155 && (0) <= tmp155) && ((tmp156 = alpha) === ~~tmp156 && ((0) <= (_ref1 = tmp156) && _ref1 < (omega + 1))))) {
      domainError();
    }
    r = (function() {
      _results = [];
  ...
  compressOrReplicate = function(omega, alpha, axis) {
    var a, b, data, filler, i, indices, n, p, shape, tmp169, x, _i, _j, _len, _ref1;
    if (!omega.shape.length) {
      omega = new APLArray([omega.unwrap()]);
    }
    axis = axis ? axis.toInt(0, omega.shape.length) : omega.shape.length - 1;
  ...
  prepareForIndexing = function(omega, alpha, axes) {
    var alphaItems, axis, d, i, subscriptShapes, subscripts, tmp170, tmp171, x, _i, _j, _k, _l, _len, _len1, _m, _ref1, _ref2, _ref3, _ref4, _results, _results1;
  ...
  addVocabulary({
    '⍉': function(omega, alpha) {
      var i, n, shape, stride, tmp172, u, x, _i, _j, _len, _len1, _ref1;
      if (alpha) {
        if (alpha.shape.length > 1) {
          rankError();
        }
    ...
    if (module === (typeof require !== "undefined" && require !== null ? require.main : void 0)) {
      (function() {
        ...
        if (file != null) {
          ...
          process.stdout.write("ngn apl 2013-11-28\n");
