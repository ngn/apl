...
define(function(require) {
  var Complex, all, assert, assignParents, builtins, closestScope, compile, die, exec, inherit, lexer, next, nodes, parser, resolveSeqs, setInput, toJavaScript, _ref, _ref1, _ref2, _ref3;
  ...
  exec = function(aplCode, opts) {
    ...
    return (new Function("var _ = arguments[0];\n" + (compile(aplCode, opts))))(inherit(builtins, opts.extraContext));
  };
  return {
    nodes: nodes,
    compile: compile,
