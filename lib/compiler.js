...
define(['./parser', './helpers', './builtins', './complex'], function(parser, helpers, builtinsModule, complex) {
  var assert, assignParents, builtinVarInfo, builtins, closestScope, compile, createHash, die, exec, execJS, hex4, inherit, jsName, ord, predefinedNames, repr, resolveSeqs, toJavaScript;
  if (parser == null) {
